...
- lstm 模型
    - 文本输入
        ...
        默认嵌入 + atten:mlp：
            python train_lstm.py --model lstm  -bs 8 -ep 30 --lr 0.001 -eb 128 --hidden-dim 256 --output-dim 8  --max-len 200  --vocab-size 278 --dataset malapi --atten mlp
        默认嵌入 + atten:self：
            python train_lstm.py --model lstm  -bs 8 -ep 30 --lr 0.001 -eb 128 --hidden-dim 256 --output-dim 8  --max-len 200  --vocab-size 278 --dataset malapi --atten self
        默认嵌入 + atten:pe：
            python train_lstm.py --model lstm  -bs 8 -ep 30 --lr 0.001 -eb 128 --hidden-dim 256 --output-dim 8  --max-len 200  --vocab-size 278 --dataset malapi --atten pe
        默认嵌入 + atten:self-pe：
            python train_lstm.py --model lstm  -bs 8 -ep 30 --lr 0.001 -eb 128 --hidden-dim 256 --output-dim 8  --max-len 200  --vocab-size 278 --dataset malapi --atten self-pe
...
- conv1d 模型
    - 文本输入
        ...
        默认嵌入 + atten:mlp：
            python train_lstm.py --model conv1d  -bs 8 -ep 30 --lr 0.001 -eb 128 --hidden-dim 256 --output-dim 8  --max-len 200  --vocab-size 278 --dataset malapi --atten mlp
        默认嵌入 + atten:self：
            python train_lstm.py --model conv1d  -bs 8 -ep 30 --lr 0.001 -eb 128 --hidden-dim 256 --output-dim 8  --max-len 200  --vocab-size 278 --dataset malapi --atten self
        默认嵌入 + atten:pe：
            python train_lstm.py --model conv1d  -bs 8 -ep 30 --lr 0.001 -eb 128 --hidden-dim 256 --output-dim 8  --max-len 200  --vocab-size 278 --dataset malapi --atten pe
        默认嵌入 + atten:self-pe：
            python train_lstm.py --model conv1d  -bs 8 -ep 30 --lr 0.001 -eb 128 --hidden-dim 256 --output-dim 8  --max-len 200  --vocab-size 278 --dataset malapi --atten self-pe
...
- TCN 模型
    -文本输入
        默认嵌入：
            python train_lstm.py --model tcn  -bs 8 -ep 30 --lr 0.001 -eb 128 --hidden-dim 256 --output-dim 8  --max-len 200  --vocab-size 278
        word2vec嵌入：
            python train_lstm.py --model tcn  -bs 8 -ep 30 --lr 0.001 -eb 128 --hidden-dim 256 --output-dim 8  --max-len 200  --vocab-size 278 -ec word2vec -lp ./checkpoints/malapiwv.wordvectors
        fasttext嵌入：
            python train_lstm.py --model tcn  -bs 8 -ep 30 --lr 0.001 -eb 128 --hidden-dim 256 --output-dim 8  --max-len 200  --vocab-size 278 -ec fasttext -lp ./checkpoints/malapift.wordvectors
      
       默认嵌入 + atten:mlp：
            python train_lstm.py --model tcn  -bs 8 -ep 30 --lr 0.001 -eb 128 --hidden-dim 256 --output-dim 8  --max-len 200  --vocab-size 278 --dataset malapi --atten mlp
        默认嵌入 + atten:self：
            python train_lstm.py --model tcn  -bs 8 -ep 30 --lr 0.001 -eb 128 --hidden-dim 256 --output-dim 8  --max-len 200  --vocab-size 278 --dataset malapi --atten self
        默认嵌入 + atten:pe：
            python train_lstm.py --model tcn  -bs 8 -ep 30 --lr 0.001 -eb 128 --hidden-dim 256 --output-dim 8  --max-len 200  --vocab-size 278 --dataset malapi --atten pe
        默认嵌入 + atten:self-pe：
            python train_lstm.py --model tcn  -bs 8 -ep 30 --lr 0.001 -eb 128 --hidden-dim 256 --output-dim 8  --max-len 200  --vocab-size 278 --dataset malapi --atten self-pe
