...
ctx = ExpContext(
    description = "MalAPI2019 恶意软件API分类实验: TextSeqClassifier + No Plugin", 
...
ctx_sa.description = "MalAPI2019 恶意软件API分类实验: TextSeqClassifier + 自注意力机制"
ctx_sa.network_config.plugin_type = PluginType.SA

ctx_sape = ctx.model_copy(deep=True)
ctx_sape.description = "MalAPI2019 恶意软件API分类实验: TextSeqClassifier + 自注意力机制 + 位置编码"
ctx_sape.network_config.plugin_type = PluginType.SelfPE

ctx_pe = ctx.model_copy(deep=True)
ctx_pe.description = "MalAPI2019 恶意软件API分类实验: TextSeqClassifier + 位置编码"
ctx_pe.network_config.plugin_type = PluginType.PosEnc

ctx_mlp = ctx.model_copy(deep=True)
ctx_mlp.description = "MalAPI2019 恶意软件API分类实验: TextSeqClassifier + MLP注意力机制"
